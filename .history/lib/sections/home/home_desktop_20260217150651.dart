...
import 'package:portfolify/widget/social_links.dart';
          ...
          Positioned(
            ...
            child: Opacity(
              ...
              child: EntranceFader(
                ...
                child: Image.asset(StaticUtils.blackWhitePhoto,
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text('WELCOME TO MY PORTFOLIO! ', style: AppText.b1!.copyWith(fontFamily: 'Montserrat')),
                    EntranceFader(
                      offset: const Offset(0, 0),
                ...
                Space.y1!,
                Text("Richard", style: AppText.h1!.copyWith(fontFamily: 'Montserrat', fontSize: AppDimensions.normalize(25), fontWeight: FontWeight.w100)),
                Text("Parulian", style: AppText.h1b!.copyWith(fontSize: AppDimensions.normalize(25), height: 1),),
                EntranceFader(
